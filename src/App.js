...
const App = () => {
  var blogs = [
    {
      "_id": crypto.createHash("SHA1").update("On Cryptography").digest('base64').toLowerCase(),
    ...
    {
      "_id": crypto.createHash("SHA1").update("My Thoughts on Genetic Algorithms").digest('base64').toLowerCase(),
