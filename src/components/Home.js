        ...
        <>
            <div className="aboutme">
                ...
                <ul>
                    ...
                    <p style={{ width: "85%", paddingLeft: "1%" }}>Blockchain is the technology of the future. I developed some basic applications of blockchain and decentralized transaction systems. I am excited to see how much we can achieve with this technology!</p>
                    <li >Cryptography</li>
